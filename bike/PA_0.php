<?php
  ...
  $content = "PA_0 viewed at time => ".date('Y-m-d').date(' H:i:s', time());
  $type = "Bike";
  echo $content;
      ...
      <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form id="frmreview" role="form" method="post" action="ASX_27.php">
              <fieldset>
                ...
                <input id="abc" class="hidden" name="rating" value="5" />
                    ...
                    <br />
                    <input type="text" class="hidden" value="PA_0" name="ProductName" />
            ...
            <!--facebook-->
            <div class="fb-like" data-href="http://www.captainlongxu.com/marketplace/bike/PA_0.php" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
            <!--facebook-->
          </div>
