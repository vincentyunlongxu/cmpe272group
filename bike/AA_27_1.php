<?php
  ...
  $content = "AA_27_1 viewed at time => ".date('Y-m-d').date(' H:i:s', time());
  $type = "Bike";
  echo $content;
          ...
          <div class="col-md-6">
              ...
              <div class="list-group-item">
                ...
                <div class="col-md-12 text-right">
                    ...
                    <div class="col-md-6">
            <form id="frmreview" role="form" method="post" action="AA_27_1.php">
              <fieldset>
                ...
                <input id="abc" class="hidden" name="rating" value="5" />
                    ...
                    <br />
                    <input type="text" class="hidden" value="AA_27_1" name="ProductName" />
            ...
            <!--facebook-->
            <div class="fb-like" data-href="http://www.captainlongxu.com/marketplace/bike/AA_27_1.php" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
            <!--facebook-->
          </div>
