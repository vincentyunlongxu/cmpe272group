<?php
  ...
  $content = "apartment viewed at time => ".date('Y-m-d').date(' H:i:s', time());
  $type = "RealEstate";
  echo $content;
      ...
      <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="fb-like" data-href="http://www.captainlongxu.com/marketplace/realestate/apartment.php" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
          </div>
